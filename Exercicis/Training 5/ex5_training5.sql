...
CREATE INDEX b ON obres (tipus) PCTFREE 33; 

/* Hash */
/*eliminar index*/ DROP CLUSTER index_hash;

CREATE CLUSTER index_hash (my_tipus number(17,0)) SINGLE TABLE 
...
/* instrucció */
SELECT sum(pressupost) from obres where tipus = 100;
